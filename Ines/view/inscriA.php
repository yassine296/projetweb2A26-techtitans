...
.logo cropped {
    /* width: 200px;
    height: 150px; */
    object-fit: cover; /* Remplit et rogne si nécessaire */
    border-radius: 10px; /* facultatif, pour les coins arrondis */
}
.logo:hover {
...
<body>
<header>
    <img src="logo.png" alt="Hezni" class="logo cropped">
  ...
  <div class="divider"></div>
    <div class="form-container">
        ...
        <form method="post" action="inscriA.php">
        <div class="row">
